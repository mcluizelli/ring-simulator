...
Output: results/placement_policies_n1000/{results.csv, summary.csv}

2026-08-04: identical to run_placement_policies.py in every constant, policy and
seed rule; only the output directory differs, so the frozen 2026-07-28 (n=100) set
is never overwritten. Re-run at n=1000 because the paper's Setup paragraph now
states that all results use n=1000, and these three numbers were the exception.
"""
...
OUT = _BootPath(f"{_RING_ROOT}/results/placement_policies_n1000")
_NB = _OS4 = None
